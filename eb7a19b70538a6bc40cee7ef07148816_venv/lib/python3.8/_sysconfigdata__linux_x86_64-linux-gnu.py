...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/www/server/python_manager/versions/3.8.12/bin',
 'BINLIBDEST': '/www/server/python_manager/versions/3.8.12/lib/python3.8',
 ...
 'CONFIG_ARGS': "'--prefix=/www/server/python_manager/versions/3.8.12'",
 'CONFINCLUDEDIR': '/www/server/python_manager/versions/3.8.12/include',
 'CONFINCLUDEPY': '/www/server/python_manager/versions/3.8.12/include/python3.8',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/Python-3.8.12/coverage.info',
 'COVERAGE_REPORT': '/tmp/Python-3.8.12/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--no-branch-coverage --title "CPython lcov '
                            'report"',
 'CPPFLAGS': '-I. -I./Include',
 'CXX': 'g++ -pthread',
 'DESTDIRS': '/www/server/python_manager/versions/3.8.12 '
             '/www/server/python_manager/versions/3.8.12/lib '
             '/www/server/python_manager/versions/3.8.12/lib/python3.8 '
             '/www/server/python_manager/versions/3.8.12/lib/python3.8/lib-dynload',
 'DESTLIB': '/www/server/python_manager/versions/3.8.12/lib/python3.8',
 'DESTPATH': '',
 'DESTSHARED': '/www/server/python_manager/versions/3.8.12/lib/python3.8/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/www/server/python_manager/versions/3.8.12/include '
                   '/www/server/python_manager/versions/3.8.12/include '
                   '/www/server/python_manager/versions/3.8.12/include/python3.8 '
                   '/www/server/python_manager/versions/3.8.12/include/python3.8',
 'INCLUDEDIR': '/www/server/python_manager/versions/3.8.12/include',
 'INCLUDEPY': '/www/server/python_manager/versions/3.8.12/include/python3.8',
 ...
 'LDVERSION': '3.8',
 'LIBC': '',
 'LIBDEST': '/www/server/python_manager/versions/3.8.12/lib/python3.8',
 'LIBDIR': '/www/server/python_manager/versions/3.8.12/lib',
 'LIBFFI_INCLUDEDIR': '',
 'LIBM': '-lm',
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/www/server/python_manager/versions/3.8.12/lib/pkgconfig',
 'LIBPL': '/www/server/python_manager/versions/3.8.12/lib/python3.8/config-3.8-x86_64-linux-gnu',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/www/server/python_manager/versions/3.8.12/lib/python3.8',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAINCC': 'gcc -pthread',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/www/server/python_manager/versions/3.8.12/share/man',
 'MKDIR_P': '/bin/mkdir -p',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/www/server/python_manager/versions/3.8.12/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SGI_ABI': '@SGI_ABI@',
 'SHELL': '/bin/sh',
 ...
 'abs_builddir': '/tmp/Python-3.8.12',
 'abs_srcdir': '/tmp/Python-3.8.12',
 'datarootdir': '/www/server/python_manager/versions/3.8.12/share',
 'exec_prefix': '/www/server/python_manager/versions/3.8.12',
